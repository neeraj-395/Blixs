      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <div className="flex gap-4 mb-3">
          <div className="w-1/2">
            ...
            <input type="text" name="first_name" required onChange={handleChange} className="w-full p-2 border rounded" />
          </div>
          <div className="w-1/2">
            <label className="block mb-1">Last Name:</label>
            <input type="text" name="last_name" required onChange={handleChange} className="w-full p-2 border rounded" />
          </div>
        </div>
